...
Write-Host '============================================================'
Write-Host 'ChurchBooks Phase 5 - Windows PowerShell 5.1 Parser Gate'
Write-Host '============================================================'
...
Write-Host '[PASS] All ChurchBooks Phase 5 PowerShell files passed the Windows PowerShell 5.1 parser gate.' -ForegroundColor Green
exit 0
