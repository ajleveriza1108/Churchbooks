...
Write-Host '============================================================'
Write-Host 'ChurchBooks Phase 10 - Windows PowerShell 5.1 Parser Gate'
Write-Host '============================================================'
...
$relativeFiles = @(
    ...
    'scripts\Validate-Phase8PowerShell51.ps1',
    'scripts\Verify-Phase8.ps1',
    'scripts\Validate-Phase9PowerShell51.ps1',
    'scripts\Verify-Phase9.ps1',
    'scripts\Validate-Phase10PowerShell51.ps1',
...
Write-Host '[PASS] All ChurchBooks Phase 10 PowerShell files passed the Windows PowerShell 5.1 parser gate.' -ForegroundColor Green
exit 0
